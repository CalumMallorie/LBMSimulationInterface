    ...
    for Ca in Ca_values:
        for Z0 in Z0_values:
            for X0 in X0_values:
                ...
                if lbmi.FileSystem.check_simulation_exists(root_directory="kostas_rerun_all/data", parameter_updates=parameter_updates.get_parameter_updates()):
                    print(f"Simulation with these parameters already exists")
                    continue
                ...
                lbmi.merge_all_timesteps(setup.simulation_directory, setup.simulation_directory+'_merged', num_cores=8)
